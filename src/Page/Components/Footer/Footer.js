    ...
    return (
        <div>
            ...
            <footer className="footer footer-center text-base-content">
                <div>
                    <p>Copyright © 2022 - All right reserved by sell buy laptop Industries Ltd</p>
                </div>
            </footer>
        </div>
    );
