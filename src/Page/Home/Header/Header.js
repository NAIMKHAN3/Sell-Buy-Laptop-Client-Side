...
const Header = () => {
    return (
        <div className='lg:w-2/3 mx-auto my-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2  my-10 border border-indigo-400'>
                <Lottie className='lg:w-[400px] p-4' animationData={lottie} loop={true} />
                <div className=' flex justify-center items-center flex-col p-4'>
                    <p className='text-3xl font-bold text-indigo-500 '>Buy Laptops with confidence  on the Sell Buy Laptop website</p>
